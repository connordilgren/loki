...
PCA_DATA_PATH = "/ephemeral/purva_exp/loki/pca"
...
def get_pca_components(args, layer_idx, head_dim, top_r, num_key_value_groups, repeat_kv, device = None):
    ...
    components_file_path = os.path.join(PCA_DATA_PATH, f"key/pca_components/pca_components_layer_{layer_idx}.pt")
    mean_file_path = os.path.join(PCA_DATA_PATH, f"key/pca_means/pca_means_layer_{layer_idx}.pt")
    explained_variance_file_path = os.path.join(PCA_DATA_PATH, f"key/pca_explained_variance/pca_explained_variance_layer_{layer_idx}.pt")
